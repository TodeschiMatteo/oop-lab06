...
public final class UseGraph {
    ...
    public static void main(final String... args) {
         ...
         */
        Method<String> methodBreadthFirst = new BreadthFirst<>();
        Graph<String> graph1 = new GraphImpl<>(methodBreadthFirst);
        testGraph(graph1);

        System.out.println();

        Method<String> methodDepthFirst = new DepthFirst<>();
        Graph<String> graph2 = new GraphImpl<>(methodDepthFirst);
        testGraph(graph2);
    }
